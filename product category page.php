        ...
        <div class="container py-3 text-dark bg-light">
            ...
            <div class="row py-2">
                ...
                <div class="col-lg-9 col-md-12">
                    <div class="card-body">
                        <h1 class="text-center">@產品分類標題@</h1>
                        <div class="mt-3">
                            <h5 style="color:#0000007a">軌道組合式端子台 (600V, 10A, 20A, 30A, 40A, 60A, 100A, 150A, 200A, 300A, 400A)</h5>
                            <img class="card-img-top img-fluid rounded mx-auto d-block mt-5" src="https://cdn.ready-market.com/1/48d29a5d//Templates/pic/SHINING-Terminal-Blocks-W270H205.jpg?v=0da0205e"
                                alt="Card image cap">
                            <h5 class="card-title text-center mt-2">▲ TA系列 35mm軌道 組合式端子台</h5>
                            <p class="card-text mt-4">享曆 TA系列 軌道組合式端子台包括 TA-010~TA-400。額定電壓: 600V。額定電流: 10A~400A。安裝於 35mm的軌道上。可組成任意P數。</p>
                            <p class="card-text mt-1">享曆SHINING TA系列 35mm軌道式端子台</p>
                            <p class="card-text mt-1">產品型號: TA-010 / TA-020 / TA-030 / TA-040 / TA-060 / TA-100 / TA-150 / TA-200 / TA-300 / TA-400</p>
                            <p class="card-text mt-1">額定電壓: 600V 額定電流: 10A / 20A / 30A / 40A / 60A / 100A / 150A / 200A / 300A / 400A</p>
                            <p class="card-text mt-1">安裝方式: 於 35mm軌道 / 面板 安裝 電極P數: 可組成任意P數</p>
                            <p class="card-text mt-1">安規認證: RoHS </p>
                            <p class="card-text mt-1"></p>TA系列端子台為軌道式端子台，以黑色為顏色基本款式。產品顏色可根據客戶需求客製變更。本系列產品除了以軌道安裝，透過兩側的安裝孔，亦可直接安裝於面板上。電流額定規格有10A, 20A,
                            30A, 40A, 60A, 100A, 150A, 200A, 300A, 400A。產品配有PVC的透明防塵蓋(軟)或透明保護蓋(硬)，提高產品的耐用度。可自由組裝所需的電極P數。在碼標紙條方面，我們也提供印字服務。
                            </p>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card box-shadow border-0 text-center h-100">
                                <img class="card-img-top img-fluid rounded mx-auto d-block" src="https://cdn.ready-market.com/1/48d29a5d//Templates/pic/m/SHINING-TA-Series-35mm-Din-Rail-Mounted-Termianl-Block-W270H205.jpg?v=3be5b30d"
                                    alt="Card image cap">
                                <div class="card-body">
                                    <h5 class="card-title">TA-010</h5>
                                    <p class="card-text">@產品敘述@</p>
                                </div>
                                <div class="card-footer border-top-0 bg-white">
