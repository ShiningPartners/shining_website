                        ...
                        <div id="leftside-navigation" class="nano">
                            ...
                            <div class="card box-shadow border-0 text-center Recommended-products">
                                <img class="card-img-top img-fluid rounded mx-auto d-block" src="https://cdn.ready-market.com/1/48d29a5d//Templates/pic/m/SHINING-TA-Series-35mm-Din-Rail-Mounted-Termianl-Block-W270H205.jpg?v=3be5b30d"
                                    alt="Card image cap">
                                <div class="card-body">
                                    <h5 class="card-title">好用端子台</h5>
                                    <p class="card-text">這很好用哦</p>
                                </div>
                                        ...
                                        <form id="form_3" class="appnitro" enctype="multipart/form-data" method="post" action="form_submit.php" target="nm_iframe">
                                            <ul>
                                                ...
                                                <li id="li_20">
                                                    ...
                                                    <p class="guidelines" id="guide_20">
                                                ...
                                                <li id="li_1">
                                                    ...
                                                    <br>
                                                    <span>
                                                        <input id="element_1_1" name="element_1_1" class="element text" maxlength="255" size="8" placeholder="First Name" value=""
                                                        />
                                                    </span>
                                                    <span>
                                                        <input id="element_1_2" name="element_1_2" class="element text" maxlength="255" size="14" placeholder="Last Name" value=""
                                                        />
                                                    </span>
                                                ...
                                                <li class="cdpr">
                                                    ...
                                                    <p style="font-size:xx-small">By consenting to this privacy notice you are giving us permission to
                                                        process your personal data specifically for the purposes identified.
                                                        Consent is required for us to process your personal data, and your
                                                        data will not be shared to third parties.</p>
                                                </li>
                                            </ul>
                                        </form>
